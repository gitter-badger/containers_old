...
# Where things are
my $TPP_WEB  = 'localhost/tpp/cgi-bin'; #'https://regis-web.systemsbiology.net/tpp-lmendoza/cgi-bin';
my $comet_url = "$TPP_WEB/comet-fastadb.cgi";
my $pepxml_url= "$TPP_WEB/peptidexml_html2.pl";
my $xslt = 'xsltproc'; #'xsltproc';
...
my $readmz_cmd= "C:/Inetpub/tpp/cgi-bin/readmzXML"; #"/tools/bin/TPP/tpp-lmendoza/bin/readmzXML";
my $wget_cmd  = 'wget';#'wget';       # full path to wget
